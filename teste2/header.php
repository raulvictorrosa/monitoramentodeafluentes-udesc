...
<html lang="en">
	<head>
		...
		<!-- stylesheets -->
		<link href="/lojavirtual/teste2/assets/bootstrap.min.css" rel="stylesheet">
		<link href="/lojavirtual/teste2/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet">
		<link href="/lojavirtual/teste2/assets/style.css" rel="stylesheet">
		
		<!-- scripts -->
		<script src="/lojavirtual/teste2/assets/js/jquery-3.1.0.min.js"></script>
		<script src="/lojavirtual/teste2/assets/js/bootstrap.min.js"></script>
		<?php //<script src="http://canvasjs.com/assets/script/canvasjs.min.js"></script> ?>
		<script src="/lojavirtual/teste2/assets/script/canvasjs.min.js"></script>
