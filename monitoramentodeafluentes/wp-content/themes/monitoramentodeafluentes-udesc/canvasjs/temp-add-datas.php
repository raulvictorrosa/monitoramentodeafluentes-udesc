...
<div class="container">
  <div class="row">
      <div class="col-sm-12">
        <h1>Adicionar Dado Temperatura Fictícia na Tabela</h1>
        <?php
        ...
        <?php var_dump($dataPoints2); echo '<pre>' . json_encode($dataPoints2, JSON_NUMERIC_CHECK) . '</pre>'; ?>
